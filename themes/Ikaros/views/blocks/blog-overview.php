  ...
  <!-- Begin Blog -->
  <h1 class="center editable" data-cms="cms.home.blog.header">{{cms.home.blog.header}}</h1>
  <div class="intro center editable" data-cms="cms.home.blog.intro">{{cms.home.blog.intro}}</div>
